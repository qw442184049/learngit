...
void Lcd_GPIO_init(void)
{
    ...
    /********Data端口设置*************/
     RCC_APB2PeriphClockCmd(RCC_GPIO_DATA, ENABLE);  //打开端口A时钟 
     ...
     GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_OD;  //标准输出模式
     ...
     GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_OD; //推挽复用输出     由GPIO_Mode_Out_PP改成GPIO_Mode_AF_PP
     GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz; //50M时钟速度
